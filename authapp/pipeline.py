...
def save_user_profile(backend, user, response, *args, **kwargs):
    ...
    if 'bdata' in data_json:
        birthday = datetime.datetime.strptime(data_json['bdate'], '%d.%m.%Y')
    ...
    if 'about' in data_json:
        user.shopuserprofile.about_me = data_json['about']  # or user.shopuserprofile.about
