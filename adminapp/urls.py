...
urlpatterns = [
    ...
    path('users/update/<int:pk>/', admin_views.users_update, name='users_update'),
    path('users/delete/<int:pk>/', admin_views.users_delete, name='users_delete'),
    ...
    path('products/<int:pk>/', admin_views.ProductsListView.as_view(), name='products_list'),
